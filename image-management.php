...
<div class="wrap">
  ...
  <form name="JaS_form" method="post" action="<?php echo $mainurl; ?>" onsubmit="return JaS_submit()"  >
    <table width="100%">
      ...
      <tr>
        ...
        Don't upload your original images into plugin folder. if you upload the images into plugin folder, you may loose the images when you upate the plugin to next version. 
        </td>
      </tr>
      <tr>
        <td height="35" colspan="3" align="left" valign="bottom"><input name="publish" lang="publish" class="button-primary" value="<?php echo @$submittext?>" type="submit" />
          <input name="publish" lang="publish" class="button-primary" onClick="JaS_redirect()" value="Cancel" type="button" /></td>
      </tr>
  ...
  <div class="tool-box">
    ...
    <form name="frm_JaS_display" method="post">
      ...
      <br />
      Note: Check official website <a href="http://www.gopiplus.com/work/2011/12/21/jquery-accordion-slideshow-wordpress-plugin/">www.gopiplus.com</a> for live demo and more help. 
    </form>
  </div>
</div>
