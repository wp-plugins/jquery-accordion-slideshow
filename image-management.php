    ...
    <form name="frm_JaS_display" method="post">
      ...
      <br />
	   <strong>Plugin Configuration</strong> <br />
		1. Add the gallery short code in the posts or pages<br /><br />
      Check official website <a href="http://www.gopiplus.com/work/2011/11/06/fancy-image-show-wordpress-plugin/">www.gopiplus.com</a> for live demo and more help. 
    </form>
  </div>
</div>
